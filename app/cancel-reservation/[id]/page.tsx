...
import Cancelcomponent from "./_components/Cancelcomponent";
...
const CancelReservationPage = ({ params }: CancelReservationPageProps) => {
  return (
    <div className=" text-white">
      ...
      <div className="bg-white h-[400px]  py-6">
        <Cancelcomponent id={params?.id} />
      </div>
    </div>
  );
};
