...
const Extras = ({ onCountChange }: ExtrasProps) => {
  ...
  return (
    <div className=" p-2">
      ...
      {/* Bowling Shoes */}
      <div className=" md:w-[292px] md:h-[214px] border-2 border-gray-300 rounded-md mt-6 flex flex-col items-center justify-center">
        <Image
          src={
      ...
      <div className="flex items-center justify-center md:justify-start lg:justify-start w-full mt-4 md:ml-20 ">
        <button
      ...
      <p className="text-lg mt-2 md:ml-[110px] flex flex-row items-center justify-center md:justify-start">{`$${(
        count * pricePerShoe
      ).toFixed(2)}`}</p>
    </div>
  );
