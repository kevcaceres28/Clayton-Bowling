  ...
  return (
    <div className=" p-3">
      ...
      <div className=" text-sm">
        ...
        <p>
          Reservaste la cancha en{time} de {month} {date}, {year}.
        </p>
        <p>
          Por favor proporcione sus datos en este formulario para realizar la
          reserva. eficaz.
        </p>
      </div>
      ...
      <div className=" flex flex-col w-full">
        {/* First Row */}
        <div className=" w-full flex flex-col md:flex-row items-center justify-between md:space-x-4 mt-3">
          {/* Full Name */}
        ...
        <div className="mt-3">
          ...
          <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row items-center justify-between md:space-x-4">
            {/* Month Dropdown */}
            <Select
              onValueChange={(value) => {
                setBirthMonth(value);
