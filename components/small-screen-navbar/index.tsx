...
const SmallScreenNavbar = ({ reserved }: { reserved: Reservations[] }) => {
  // console.log("🚀 ~ Small Screen Navbar", reserved);
  ...
  const reservationsHeight = isReservationsOpen
    ? navItems!.find((item) => item!.name === "Reservas")!.subItems!.length *
              ...
              {reserved ? (
                <>
                  <div className="text-black w-full">
                    {/* <h1 className="text-3xl">Reservations Data</h1> */}
                      ...
                      {reserved?.map((reservation, index) => (
                        ...
                        >
                          ...
                          <div className=" flex items-center space-x-1">
                            <p>{reservation?.dayOfWeek} , </p>
                            <p> {reservation?.month}</p>
                            <p>{reservation?.dateOfMonth}</p>
                          </div>
                          <p>Time : {reservation?.time}</p>
                          <p>Price : {reservation?.price}</p>
                          <p>ExtraPrice : {reservation?.extraPrice}</p>
